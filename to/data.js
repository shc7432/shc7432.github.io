...
urldata.push({name:"colorSelect",url:"/download/apps/smallapp/color-selected"})
urldata.push({name:"czs",url:"/download/apps/smallapp/water-content"})
urldata.push({name:"waterContent",url:"/download/apps/smallapp/water-content"})
urldata.push({name:"yxh",url:"/download/apps/smallapp/reprint/yxhscq"})
urldata.push({name:"atpeople",url:"/download/apps/smallapp/at-bilibili-user"})
urldata.push({name:"4天瘦20斤完美计划",url:"/download/apps/smallapp/perfect-plan-for-4-days"})
